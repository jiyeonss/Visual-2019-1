...
{
    public partial class Form1 : Form //변수마다 private(디폴트)
    {
        ...
        public Form1()
        {
            ...
            this.Text = "ECG/PPG";
            this.WindowState = FormWindowState.Maximized; //폼이 처음에 시작할때 꽉참
        ...
        int cursorX = 0; //현재 디스플레이 되는 데이터의 시작점
        ...
        private void PpgRead()
        {
            ...
            string[] lines = File.ReadAllLines(fileName); //파일네임에서 모든 라인을 읽어와서 배열에 넣음
